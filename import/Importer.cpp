...
QList<Triangle> Importer::import(QString path) {
    ...
    QList<Triangle> triangles = Importer::_generate_triangles(faces);
    return triangles;
}
...
QList<Triangle> Importer::_generate_triangles(QList<QList<QVector3D> > faces) {
